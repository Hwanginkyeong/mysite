...
<link href="/mysite/assets/css/mysite.css" rel="stylesheet" type="text/css"> <!--mysite는 주소를 의미--> 
...
<body>
	<div id="wrap">
		...
		<div id="header" class="clearfix">
			...
			<!-- 로그인 실패, 로그인 전 이거나  -->
			<ul>
				<li><a href="/mysite/user?action=loginForm" class="btn_s">로그인</a></li> <!-- a 링크건게 주소치고 엔터친거랑 똑같음  -->
